...
test_that("Values are as expected", {
  ...
  expect_equal(lb[[121, "sites"]], 26932.6, tolerance = 0.1)

  expect_equal(lb[[1, "latent"]], 0, tolerance = 0.1)
  expect_equal(lb[[121, "latent"]], 0, tolerance = 0.1)

  expect_equal(lb[[1, "infectious"]], 0, tolerance = 0.1)
  expect_equal(lb[[121, "infectious"]], 0.1, tolerance = 0.1)

  expect_equal(lb[[1, "removed"]], 0, tolerance = 0.1)
  expect_equal(lb[[121, "removed"]], 43.9, tolerance = 0.1)

  expect_equal(lb[[1, "senesced"]], 0, tolerance = 0.1)
  expect_equal(lb[[121, "senesced"]], 20606.0, tolerance = 0.1)

  expect_equal(lb[[1, "rateinf"]], 0, tolerance = 0.1)
  expect_equal(lb[[121, "rateinf"]], 0, tolerance = 0.1)

  expect_equal(lb[[1, "rtransfer"]], 0, tolerance = 0.1)
  expect_equal(lb[[121, "rtransfer"]], 0, tolerance = 0.1)

  expect_equal(lb[[1, "rgrowth"]], 58.8, tolerance = 0.1)
  expect_equal(lb[[121, "rgrowth"]], 271.4, tolerance = 0.1)

  expect_equal(lb[[1, "rsenesced"]], 6.0, tolerance = 0.1)
  expect_equal(lb[[121, "rsenesced"]], 269.3, tolerance = 0.1)

  expect_equal(lb[[1, "diseased"]], 0, tolerance = 0.1)
  expect_equal(lb[[121, "diseased"]], 44.1, tolerance = 0.1)

  expect_equal(lb[[1, "intensity"]], 0, tolerance = 0.1)
  expect_equal(lb[[121, "intensity"]], 0, tolerance = 0.1)
