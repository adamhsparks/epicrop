...
ggplot(data = dat,
  ...
  labs(title = "Bacterial blight disease progress over time",
       caption = "These data were obtained from the NASA Langley Research Center POWER Project funded through the NASA Earth Science Directorate Applied Science Program.") +
   theme_light()
```
